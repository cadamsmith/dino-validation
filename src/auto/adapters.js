...
const adapters = {
  ...
  addMinMax: function(adapterName, minRuleName, maxRuleName, minMaxRuleName, minAttribute, maxAttribute) {
  ...
  addSingleVal: function(adapterName, attribute, ruleName) {
    return this.add(adapterName, [attribute || "val"], function (options) {
      setValidationValues(options, ruleName || adapterName, options.params.value);
    });
  }
};
...
adapters.add("equalto", ["other"], function (options) {
  ...
  const element = [...options.form.querySelectorAll('input, textarea, select, button')]
